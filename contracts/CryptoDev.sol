...
contract CryptoDevs is ERC721Enumerable,Ownable{
    ...
    /**
     * @dev ERC721 constructor takes ina a 'name' and a 'symbol' to the token collection.
     * name in our case is the 'Crypto Devs' and symbol is 'CD'.
     * Constructor for Crypto Devs takes in the baseURI to set baseTokenURI for the collection.
    ...
    function mint()public payable{
        //Make sure we always leave enough room for whitelist for reservations
        ...
        /**
         * @dev withdraw sends all tje ether in the contract
